...
#define INTERVAL_MS_PRINT 1000 													// Sets the minimum time interval between printing sensor data in the loop to avoid flooding the serial output. higher measn slower 
